...
public final class FileUtils {
    public static void write(String dest, byte[] bytes) {
        ...
        try {
            ...
            AccountMap.getLogger().warn("Failed to write file: " + dest);
        }
    }
    ...
    public static byte[] read(Path path) {
        try {
            ...
            AccountMap.getLogger().warn("Failed to read file: " + path);
        }
    ...
    public static InputStream readResourceAsStream(String resourcePath) {
        return AccountMap.class.getResourceAsStream(resourcePath);
    }

    public static byte[] readResource(String resourcePath) {
        try (InputStream is = AccountMap.class.getResourceAsStream(resourcePath)) {
            return is.readAllBytes();
        } catch (Exception exception) {
            AccountMap.getLogger().warn("Failed to read resource: " + resourcePath);
    ...
    public static void copyResource(String resourcePath, String destination) {
        try {
            ...
            AccountMap.getLogger().warn("Failed to copy resource: " + resourcePath + "\n" + exception);
        }
    }
    ...
    public static List<Path> getPathsFromResource(String folder) throws URISyntaxException {
        ...
        URI pathUri = AccountMap.class.getProtectionDomain()
            .getCodeSource()
            .getLocation()
            .toURI();
